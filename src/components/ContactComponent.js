...
class Contact extends Component {
    ...
    validate(firstname, lastname, telnum, email){
        ...
        if(this.state.touched.telnum && !reg.test(telnum))
            errors.telnum = 'Telnum should be contain only numbers.';
                    ...
                    <div className="col-12 col-md-9">
                        <LocalForm onSubmit={(values) => {this.handleSubmit(values)}}>
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    <Control.text model=".lastname" type="text" className="form-control" id="lastname" name="lastname"/>
                                </Col>                        
                            </Row>
                            <Row className="form-group">
                            <Label htmlFor="telnum" md={2}>Contact Tel.</Label>
                                <Col md={10}>
                                    <Control.text model=".telnum" className="form-control" type="tel" id="telnum" name="telnum"/>                               
                                </Col>
                            </Row>
                            <Row className="form-group">
                            ...
                            <Row className="form-group">
                                <Col md={{size: 6, offset: 2}}>
                                    <Row check>
                                        <Label check>
                                            <Control.checkbox model=".agree" className="form-check-input" type="checkbox"
                                                name="agree"/> {' '}
